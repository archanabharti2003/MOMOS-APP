...
function updateCart(momos) {
  axios.post('./update-cart', momos).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var momos = JSON.parse(btn.dataset.momos);
    updateCart(momos);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmomos_app"] = self["webpackChunkmomos_app"] || [];
